...
public class RespondNatC extends NatC {
    ...
    public static final Range RESPOND_1_LEVEL = new Range(7, 10);
    ...
    public static PositionCalls oneDiamond(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._1S, points(RESPOND_1_LEVEL), shape(5, 10), longerOrEqualTo(Suit.Hearts)),


                propertiesAgreeTrump(new Call[]{Bid._2D, Bid._3D, Bid._5D}, OpenBid2NatC::responderRaisedMinor, true),
