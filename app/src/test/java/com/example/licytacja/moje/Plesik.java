...
public class Plesik {
    ...
    public void testAILicytacja() {
        ...
        game.getDeal().put(Direction.N, Hand.parse("AKJ.T92.QJ8.7654"));
        ...
        state.makeCall(Call.parse("1D")); // North otwiera
        state.makeCall(Call.PASS);        // East pasuje
        state.makeCall(Call.parse("1S")); // South (partner) licytuje 1 Pik
